    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
	    ...
	    mkdir -p $out/share/man/man1
            ...
            cp app-icon.svg $out/share/icons/hicolor/scalable/apps/kubux-ai-image-generator.svg
            ...
            for size in 16x16 22x22 24x24 32x32 48x48 64x64 96x96 128x128 192x192 256x256; do
              ...
              w=''${size%x*}; h=''${size#*x}
              rsvg-convert -w $w -h $h -o $out/share/icons/hicolor/$size/apps/kubux-ai-image-generator.png app-icon.svg
            done
          '';
