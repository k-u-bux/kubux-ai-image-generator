...
#
# OpenRouter variant of kubux-ai-image-generator.py
# (API calls go to https://openrouter.ai; model list and parameter
#  handling are tailored to the OpenRouter API. The original
#  Together.ai version is kept unchanged alongside this file.)
#
...
ai_features_enabled = bool(OPENROUTER_API_KEY)
...
def filter_formats ( formats, predicate ):
    return [ p for p in formats if predicate( p ) ]

def select_best_dimensions_from_model(canvas_width, canvas_height, model_formats, scale):
    """
    Select the best dimensions from model's available formats.
    
    Args:
        canvas_width, canvas_height: Current canvas dimensions
        model_formats: List of (width, height) tuples from MODEL_SPECS
        scale: The image_scale slider value (0.0 to 9.5)
    
    Returns:
        (width, height): Best matching dimensions from model's formats
    """
    import math
    model_formats.sort( key = ratio )

    # Calculate target aspect ratio from canvas
    target_ratio = canvas_width / canvas_height
    
    # Calculate initial diagonal max based on slider (exponential)
...
# Note: OpenRouter does not expose steps/reference_strength parameters;
#  the sliders remain in the UI but only prompt, model, and size are sent.
# Model capabilities and aspect ratios are sourced from the OpenRouter
# Image API (https://openrouter.ai/api/v1/images/models).
MODEL_SPECS = [
    ("Black Forest Labs: FLUX.2 Flex", "black-forest-labs/flux.2-flex", [(1024, 1024), (1344, 1024), (1024, 1344), (1536, 1024), (1024, 1536), (1792, 1024), (1024, 1792), (2368, 1024)], False, None, False, False, False, True),
    ("Black Forest Labs: FLUX.2 Klein 4B", "black-forest-labs/flux.2-klein-4b", [(1024, 1024), (1344, 1024), (1024, 1344), (1536, 1024), (1024, 1536), (1792, 1024), (1024, 1792), (2368, 1024)], False, None, False, False, False, True),
    ("Black Forest Labs: FLUX.2 Max", "black-forest-labs/flux.2-max", [(1024, 1024), (1344, 1024), (1024, 1344), (1536, 1024), (1024, 1536), (1792, 1024), (1024, 1792), (2368, 1024)], False, None, False, False, False, True),
    ("Black Forest Labs: FLUX.2 Pro", "black-forest-labs/flux.2-pro", [(1024, 1024), (1344, 1024), (1024, 1344), (1536, 1024), (1024, 1536), (1792, 1024), (1024, 1792), (2368, 1024)], False, None, False, False, False, True),
    ("ByteDance Seed: Seedream 4.5", "bytedance-seed/seedream-4.5", [(4096, 4096), (4096, 8192), (8192, 4096), (4096, 6144), (6144, 4096), (4096, 5440), (5440, 4096), (4096, 5120), (5120, 4096), (4096, 7296), (7296, 4096), (4096, 8896), (8896, 4096), (4096, 9088), (9088, 4096), (4096, 9536), (9536, 4096)], False, None, False, False, False, True),
    ("ByteDance Seed: Seedream 5.0 Lite", "bytedance-seed/seedream-5-0-lite", [(4096, 4096), (4096, 8192), (8192, 4096), (4096, 6144), (6144, 4096), (4096, 5440), (5440, 4096), (4096, 5120), (5120, 4096), (4096, 7296), (7296, 4096), (4096, 8896), (8896, 4096), (4096, 9088), (9088, 4096), (4096, 9536), (9536, 4096)], False, None, False, False, False, True),
    ("ByteDance Seed: Seedream 5.0 Pro", "bytedance-seed/seedream-5-0-pro", [(2048, 2048), (2048, 4096), (4096, 2048), (2048, 3072), (3072, 2048), (2048, 2752), (2752, 2048), (2048, 2560), (2560, 2048), (2048, 3648), (3648, 2048), (2048, 4416), (4416, 2048), (2048, 4544), (4544, 2048), (2048, 4800), (4800, 2048)], False, None, False, False, False, True),
    ("Google: Nano Banana (Gemini 2.5 Flash Image)", "google/gemini-2.5-flash-image", [(1024, 1024), (1024, 1536), (1536, 1024), (1024, 1344), (1344, 1024), (1024, 1280), (1280, 1024), (1024, 1792), (1792, 1024), (2368, 1024)], False, None, False, False, False, True),
    ("Google: Nano Banana Pro (Gemini 3 Pro Image)", "google/gemini-3-pro-image", [(4096, 4096), (4096, 6144), (6144, 4096), (4096, 5440), (5440, 4096), (4096, 5120), (5120, 4096), (4096, 7296), (7296, 4096), (9536, 4096)], False, None, False, False, False, True),
    ("Google: Nano Banana Pro (Gemini 3 Pro Image Preview)", "google/gemini-3-pro-image-preview", [(4096, 4096), (4096, 6144), (6144, 4096), (4096, 5440), (5440, 4096), (4096, 5120), (5120, 4096), (4096, 7296), (7296, 4096), (9536, 4096)], False, None, False, False, False, True),
    ("Google: Nano Banana 2 (Gemini 3.1 Flash Image)", "google/gemini-3.1-flash-image", [(4096, 4096), (4096, 16384), (4096, 32768), (4096, 6144), (6144, 4096), (4096, 5440), (16384, 4096), (5440, 4096), (4096, 5120), (5120, 4096), (32768, 4096), (4096, 7296), (7296, 4096), (9536, 4096)], False, None, False, False, False, True),
    ("Google: Nano Banana 2 (Gemini 3.1 Flash Image Preview)", "google/gemini-3.1-flash-image-preview", [(4096, 4096), (4096, 16384), (4096, 32768), (4096, 6144), (6144, 4096), (4096, 5440), (16384, 4096), (5440, 4096), (4096, 5120), (5120, 4096), (32768, 4096), (4096, 7296), (7296, 4096), (9536, 4096)], False, None, False, False, False, True),
    ("Google: Nano Banana 2 Lite (Gemini 3.1 Flash Lite Image)", "google/gemini-3.1-flash-lite-image", [(1024, 1024), (1024, 4096), (1024, 8192), (1024, 1536), (1536, 1024), (1024, 1344), (4096, 1024), (1344, 1024), (1024, 1280), (1280, 1024), (8192, 1024), (1024, 1792), (1792, 1024), (2368, 1024)], False, None, False, False, False, True),
    ("Krea: Krea 2 Large", "krea/krea-2-large", [(1024, 1024), (1344, 1024), (1536, 1024), (1792, 1024), (1024, 1280), (1024, 1536), (1024, 1792)], False, None, False, False, False, True),
    ("Krea: Krea 2 Medium", "krea/krea-2-medium", [(1024, 1024), (1344, 1024), (1536, 1024), (1792, 1024), (1024, 1280), (1024, 1536), (1024, 1792)], False, None, False, False, False, True),
    ("Krea: Krea 2 Medium Turbo", "krea/krea-2-medium-turbo", [(1024, 1024), (1344, 1024), (1536, 1024), (1792, 1024), (1024, 1280), (1024, 1536), (1024, 1792)], False, None, False, False, False, True),
    ("Meta: Muse Image", "meta/muse-image", [(1024, 1024)], False, None, False, False, False, False),
    ("Microsoft: MAI-Image-2.5", "microsoft/mai-image-2.5", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792), (1536, 1024), (1024, 1536)], False, None, False, False, False, True),
    ("Microsoft: MAI-Image-2.5 Pro", "microsoft/mai-image-2.5-pro", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792), (1536, 1024), (1024, 1536)], False, None, False, False, False, True),
    ("OpenAI: GPT-5 Image", "openai/gpt-5-image", [(1024, 1024), (1536, 1024), (1024, 1536)], False, None, False, False, False, True),
    ("OpenAI: GPT-5 Image Mini", "openai/gpt-5-image-mini", [(1024, 1024), (1536, 1024), (1024, 1536)], False, None, False, False, False, True),
    ("OpenAI: GPT-5.4 Image 2", "openai/gpt-5.4-image-2", [(1024, 1024), (1536, 1024), (1024, 1536), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792), (2368, 1024)], False, None, False, False, False, True),
    ("OpenAI: GPT Image 1", "openai/gpt-image-1", [(1024, 1024), (1536, 1024), (1024, 1536)], False, None, False, False, False, True),
    ("OpenAI: GPT Image 1 Mini", "openai/gpt-image-1-mini", [(1024, 1024), (1536, 1024), (1024, 1536)], False, None, False, False, False, True),
    ("OpenAI: GPT Image 2", "openai/gpt-image-2", [(1024, 1024), (1536, 1024), (1024, 1536), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792), (2368, 1024)], False, None, False, False, False, True),
    ("Qwen: Qwen Image 3", "qwen/qwen-image-3", [(2048, 2048), (2048, 4096), (2048, 8192), (4096, 2048), (2048, 3072), (3072, 2048), (2048, 2752), (8192, 2048), (2752, 2048), (2048, 2560), (2560, 2048), (2048, 3648), (3648, 2048)], False, None, False, False, False, True),
    ("Qwen: Qwen Image 3 Pro", "qwen/qwen-image-3-pro", [(2048, 2048), (2048, 4096), (2048, 8192), (4096, 2048), (2048, 3072), (3072, 2048), (2048, 2752), (8192, 2048), (2752, 2048), (2048, 2560), (2560, 2048), (2048, 3648), (3648, 2048)], False, None, False, False, False, True),
    ("Recraft: Recraft V3", "recraft/recraft-v3", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4", "recraft/recraft-v4", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4 Pro", "recraft/recraft-v4-pro", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4 Pro Vector", "recraft/recraft-v4-pro-vector", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4 Styles", "recraft/recraft-v4-styles", [(1024, 1024), (2048, 1024), (1024, 2048), (1536, 1024), (1024, 1536), (1344, 1024), (1024, 1344), (1280, 1024), (1024, 1280), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4 Styles Pro", "recraft/recraft-v4-styles-pro", [(1024, 1024), (2048, 1024), (1024, 2048), (1536, 1024), (1024, 1536), (1344, 1024), (1024, 1344), (1280, 1024), (1024, 1280), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4 Styles Pro Vector", "recraft/recraft-v4-styles-pro-vector", [(1024, 1024), (2048, 1024), (1024, 2048), (1536, 1024), (1024, 1536), (1344, 1024), (1024, 1344), (1280, 1024), (1024, 1280), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4 Styles Vector", "recraft/recraft-v4-styles-vector", [(1024, 1024), (2048, 1024), (1024, 2048), (1536, 1024), (1024, 1536), (1344, 1024), (1024, 1344), (1280, 1024), (1024, 1280), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4 Vector", "recraft/recraft-v4-vector", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4.1", "recraft/recraft-v4.1", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4.1 Pro", "recraft/recraft-v4.1-pro", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4.1 Pro Vector", "recraft/recraft-v4.1-pro-vector", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4.1 Utility", "recraft/recraft-v4.1-utility", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4.1 Utility Pro", "recraft/recraft-v4.1-utility-pro", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Recraft: Recraft V4.1 Vector", "recraft/recraft-v4.1-vector", [(1024, 1024), (1344, 1024), (1024, 1344), (1792, 1024), (1024, 1792)], False, None, False, False, False, True),
    ("Sourceful: Riverflow V2 Fast", "sourceful/riverflow-v2-fast", [(4096, 4096), (5440, 4096), (4096, 5440), (6144, 4096), (4096, 6144), (7296, 4096), (4096, 7296), (9536, 4096)], False, None, False, False, False, True),
    ("Sourceful: Riverflow V2 Pro", "sourceful/riverflow-v2-pro", [(4096, 4096), (5440, 4096), (4096, 5440), (6144, 4096), (4096, 6144), (7296, 4096), (4096, 7296), (9536, 4096)], False, None, False, False, False, True),
    ("Sourceful: Riverflow V2.5 Fast", "sourceful/riverflow-v2.5-fast", [(2048, 2048), (2752, 2048), (2048, 2752), (3072, 2048), (2048, 3072), (3648, 2048), (2048, 3648), (4800, 2048)], False, None, False, False, False, True),
    ("Sourceful: Riverflow V2.5 Pro", "sourceful/riverflow-v2.5-pro", [(4096, 4096), (5440, 4096), (4096, 5440), (6144, 4096), (4096, 6144), (7296, 4096), (4096, 7296), (9536, 4096)], False, None, False, False, False, True),
    ("xAI: Grok Imagine Image 2.0", "x-ai/grok-imagine-image-2.0", [(2048, 2048), (2048, 2752), (2752, 2048), (2048, 3648), (3648, 2048), (2048, 3072), (3072, 2048), (2048, 4416), (4416, 2048), (2048, 4544), (4544, 2048), (2048, 4096), (4096, 2048)], False, None, False, False, False, True),
    ("SpaceXAI: Grok Imagine Image Quality", "x-ai/grok-imagine-image-quality", [(2048, 2048), (2048, 2752), (2752, 2048), (2048, 3648), (3648, 2048), (2048, 3072), (3072, 2048), (2048, 4416), (4416, 2048), (2048, 4544), (4544, 2048), (2048, 4096), (4096, 2048)], False, None, False, False, False, True),
]

HOME_DIR = os.path.expanduser('~')
CONFIG_DIR = os.path.join(HOME_DIR, ".config", "kubux-ai-image-generator-or")
...
def _decode_data_url(data_url, error_callback):
    ...
    try:
        ...
        if "jpeg" in header or "jpg" in header:
            ...
            suffix = ".webp"
        tmp_path = os.path.join(CONFIG_DIR, f"or_image_{secrets.token_urlsafe(12).replace('/', '_')}{suffix}")
...
def _generate_via_images_endpoint(payload, error_callback):
    """POST to /images/generations (OpenAI-compatible). Returns URL, local path, or None."""
    try:
        ...
        return None  # caller falls back to chat completions

def _generate_via_chat_endpoint(payload, error_callback):
    """Fallback: chat completions with modalities [image, text]."""
    try:
        chat_payload = {
            "model": payload["model"],
        ...
        if images and images[0].get("image_url", {}).get("url"):
            url = images[0]["image_url"]["url"]
            if url.startswith("data:"):
                return _decode_data_url(url, error_callback)
            return url
        error_callback("API Error", f"OpenRouter chat completion returned no image: {message}")
        return None
    except Exception as e:
...
def generate_image(prompt, width, height, model, steps, reference_strength, neg_prompt, context,
    ...
    # primary path: OpenAI-compatible images/generations endpoint
    result = _generate_via_images_endpoint(params, error_callback)
    if result:
        return result
    # fallback path: chat completions with image modality
    return _generate_via_chat_endpoint(params, error_callback)
...
class FullscreenImageViewer(tk.Toplevel):
    ...
    def get_aspect_ratio(self, the_scale=1.0):
        ...
        model_formats = MODEL_SPECS[self.master.model_index][2]
        return select_best_dimensions_from_model(w, h, model_formats, the_scale)
        ...
        if True:
            ...
            if True:
                ...
                self.scale_slider = tk.Scale(
                    dummy_B_frame, from_=0.0, to=10.0, resolution=0.1, orient="horizontal", showvalue=False
                )
