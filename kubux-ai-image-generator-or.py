...
MODEL_SPECS = [
    ("Black Forest Labs: FLUX.2 Flex", "black-forest-labs/flux.2-flex", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Black Forest Labs: FLUX.2 Klein 4B", "black-forest-labs/flux.2-klein-4b", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Black Forest Labs: FLUX.2 Max", "black-forest-labs/flux.2-max", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Black Forest Labs: FLUX.2 Pro", "black-forest-labs/flux.2-pro", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("ByteDance Seed: Seedream 4.5", "bytedance-seed/seedream-4.5", generate_formats( 256, 4096, 64 ), False, None, False, False, False, True),
    ("ByteDance Seed: Seedream 5.0 Lite", "bytedance-seed/seedream-5-0-lite", generate_formats( 256, 4096, 64 ), False, None, False, False, False, True),
    ("ByteDance Seed: Seedream 5.0 Pro", "bytedance-seed/seedream-5-0-pro", generate_formats( 256, 2048, 32 ), False, None, False, False, False, True),
    ("Google: Nano Banana (Gemini 2.5 Flash Image)", "google/gemini-2.5-flash-image", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Google: Nano Banana Pro (Gemini 3 Pro Image)", "google/gemini-3-pro-image", generate_formats( 256, 4096, 64 ), False, None, False, False, False, True),
    ("Google: Nano Banana Pro (Gemini 3 Pro Image Preview)", "google/gemini-3-pro-image-preview", generate_formats( 256, 4096, 64 ), False, None, False, False, False, True),
    ("Google: Nano Banana 2 (Gemini 3.1 Flash Image)", "google/gemini-3.1-flash-image", generate_formats( 256, 4096, 64 ), False, None, False, False, False, True),
    ("Google: Nano Banana 2 (Gemini 3.1 Flash Image Preview)", "google/gemini-3.1-flash-image-preview", generate_formats( 256, 4096, 64 ), False, None, False, False, False, True),
    ("Google: Nano Banana 2 Lite (Gemini 3.1 Flash Lite Image)", "google/gemini-3.1-flash-lite-image", generate_formats( 256, 1024, 32 ), False, None, False, False, False, True),
    ("Krea: Krea 2 Large", "krea/krea-2-large", generate_formats( 256, 1024, 32 ), False, None, False, False, False, True),
    ("Krea: Krea 2 Medium", "krea/krea-2-medium", generate_formats( 256, 1024, 32 ), False, None, False, False, False, True),
    ("Krea: Krea 2 Medium Turbo", "krea/krea-2-medium-turbo", generate_formats( 256, 1024, 32 ), False, None, False, False, False, True),
    ("Meta: Muse Image", "meta/muse-image", generate_formats( 256, 1440, 32 ), False, None, False, False, False, False),
    ("Microsoft: MAI-Image-2.5", "microsoft/mai-image-2.5", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Microsoft: MAI-Image-2.5 Pro", "microsoft/mai-image-2.5-pro", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("OpenAI: GPT-5 Image", "openai/gpt-5-image", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("OpenAI: GPT-5 Image Mini", "openai/gpt-5-image-mini", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("OpenAI: GPT-5.4 Image 2", "openai/gpt-5.4-image-2", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("OpenAI: GPT Image 1", "openai/gpt-image-1", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("OpenAI: GPT Image 1 Mini", "openai/gpt-image-1-mini", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("OpenAI: GPT Image 2", "openai/gpt-image-2", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Qwen: Qwen Image 3", "qwen/qwen-image-3", generate_formats( 256, 2048, 32 ), False, None, False, False, False, True),
    ("Qwen: Qwen Image 3 Pro", "qwen/qwen-image-3-pro", generate_formats( 256, 2048, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V3", "recraft/recraft-v3", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4", "recraft/recraft-v4", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4 Pro", "recraft/recraft-v4-pro", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4 Pro Vector", "recraft/recraft-v4-pro-vector", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4 Styles", "recraft/recraft-v4-styles", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4 Styles Pro", "recraft/recraft-v4-styles-pro", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4 Styles Pro Vector", "recraft/recraft-v4-styles-pro-vector", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4 Styles Vector", "recraft/recraft-v4-styles-vector", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4 Vector", "recraft/recraft-v4-vector", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4.1", "recraft/recraft-v4.1", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4.1 Pro", "recraft/recraft-v4.1-pro", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4.1 Pro Vector", "recraft/recraft-v4.1-pro-vector", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4.1 Utility", "recraft/recraft-v4.1-utility", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4.1 Utility Pro", "recraft/recraft-v4.1-utility-pro", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Recraft: Recraft V4.1 Vector", "recraft/recraft-v4.1-vector", generate_formats( 256, 1440, 32 ), False, None, False, False, False, True),
    ("Sourceful: Riverflow V2 Fast", "sourceful/riverflow-v2-fast", generate_formats( 256, 4096, 64 ), False, None, False, False, False, True),
    ("Sourceful: Riverflow V2 Pro", "sourceful/riverflow-v2-pro", generate_formats( 256, 4096, 64 ), False, None, False, False, False, True),
    ("Sourceful: Riverflow V2.5 Fast", "sourceful/riverflow-v2.5-fast", generate_formats( 256, 2048, 32 ), False, None, False, False, False, True),
    ("Sourceful: Riverflow V2.5 Pro", "sourceful/riverflow-v2.5-pro", generate_formats( 256, 4096, 64 ), False, None, False, False, False, True),
    ("xAI: Grok Imagine Image 2.0", "x-ai/grok-imagine-image-2.0", generate_formats( 256, 2048, 32 ), False, None, False, False, False, True),
    ("SpaceXAI: Grok Imagine Image Quality", "x-ai/grok-imagine-image-quality", generate_formats( 256, 2048, 32 ), False, None, False, False, False, True),
]
